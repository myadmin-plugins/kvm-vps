...
class Plugin
{
    ...
    public static function getSettings(GenericEvent $event)
    {
        ...
        $settings->add_dropdown_setting(self::$module, _('Out of Stock'), 'outofstock_kvm_storage_ny', _('Out Of Stock KVM Storage NY'), _('Enable/Disable Sales Of This Type'), $settings->get_setting('OUTOFSTOCK_KVM_STORAGE_NY'), ['0', '1'], ['No', 'Yes']);
